	...
	<div>
		<div class="container">
			...
			<div style="text-align: center">
				...
				<el-button size="small" @click="handleUpdate">保存して新しく作成</el-button>
				...
				<el-row style="padding-top: 20px">
					<el-col :span="12">
						<el-form-item label="郵便番号" prop="postalCode">
							<el-input v-model="customer.postalCode"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="得意分野" prop="expertiseAreas">
							<SelectExpertiseAreas v-model="customer.expertiseAreas"></SelectExpertiseAreas>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="従業員数" prop="employeesNumber">
							<el-input v-model="customer.employeesNumber"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="取引先の種別" prop="customerCategory">
							<SelectCustomerCategory v-model="customer.customerCategory"></SelectCustomerCategory>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="年間売上" prop="AnnualSales">
							<el-input v-model="customer.AnnualSales"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="支店名" prop="BranchName">
							<el-input v-model="customer.BranchName"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="口座番号" prop="Accounts">
							<el-input v-model="customer.Accounts"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="締め日" prop="dealDate">
							<el-input v-model="customer.dealDate"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="支払サイト" prop="Payment">
							<el-input v-model="customer.Payment"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="名義人" prop="nominalPerson">
							<el-input v-model="customer.nominalPerson"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="預金種別" prop="depositCategory">
							<SelectDepositCategory v-model="customer.customerCategory"></SelectDepositCategory>
						</el-form-item>
					</el-col>
				</el-row>
				<div class="border" style="margin-right: -20px;">所有者会社追加情報 (暫定）</div>
				<el-row style="padding-top: 20px">
					<el-col :span="12">
						<el-form-item label="銀行名" prop="bankName">
							<el-input v-model="customer.bankName"></el-input>
			...
			<div style="text-align: center">
				<el-button size="small" @click="handleSave">保存</el-button>
				<el-button size="small" @click="handleSave">保存して新しく作成</el-button>
				<el-button size="small" @click="handleCancel">キャンセル</el-button>
			</div>
			<br />
			</el-form>
...
import SelectDepositCategory from '@/components/SelectDepositCategory'
export default {
	components: { SelectExpertiseAreas,SelectCustomerCategory,SelectDepositCategory },
	data() {
		return {
			dialogVisible: false,
			nameOrPhone: "",
